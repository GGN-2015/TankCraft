...
void UserInfo::GetUserInfoTcpData(TcpData* tcpData) const
{
    ...
    Utils::DumpUnsignedShortToBuffer(buf, 4, (unsigned short)userNameLen);       /* pos4: 登录名长度 2 字节 */
    Utils::DumpRawStringToBuffer(buf, 6, (char*)mUserName.c_str(), userNameLen); /* pos6: 字符串 */
